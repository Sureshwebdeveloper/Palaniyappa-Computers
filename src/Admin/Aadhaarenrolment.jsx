// src/components/AadharEnrolmentTable.jsx
...
const AadharEnrolmentTable = () => {
  ...
  return (
    <div className="p-4">
      <h2 className="text-2xl font-bold mb-4 text-dark">Aadhar Enrolment Dashboard</h2>
      ...
      >
        <div>
          <label className="block text-sm font-semibold mb-1 text-dark">Enrolment Count</label>
          <input
            type="number"
            value={count}
              ...
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="px-4 py-2 text-xs font-medium text-gray-500 uppercase">Enrolment Count</th>
                ...
                <tbody>
                  ...
                  <tr className="bg-gray-100 font-bold">
                    ...
                    <td className="px-4 py-2">₹{grandTotalEarnings}</td>
                    <td className="px-4 py-2">-</td>
                  </tr>
                </tbody>
              </table>
      ...
      {/* GRAND TOTAL SECTION */}
      {entries.length > 0 && (
        <div className="border rounded-lg border-gray-300  p-4 bg-primary text-light mt-8 text-lg font-bold shadow">
          <h3 className="text-xl mb-2">Grand Total Across All Entries</h3>
